...
<div class="main-content">
    <section id="photos">
        <a href="/player/{{$shows->first()->id}}" class="letitbe">
            <img src="{{$shows->first()->thumbnail}}" style="max-height: 700px;">
            <h1>{{$shows->first()->heading}}</h1>
            <p>{{$shows->first()->description}}</p>
        </a>
    </section>
</div>
        ...
        <div class="col-md-10">
            ...
            <div class="tab-content">
                <div id="bmg1" class="tab-pane fade in active">
                    <br><br>
                    @if(count($shows->where('show_type','1'))>0)
                    <!-------------------------->
                        @foreach($shows->where('show_type','1') as $show)
                        <div class="row">
                ...
                <div id="bd" class="tab-pane fade">
                    ...
                    @if(count($shows->where('show_type','2'))>0)
                    <!-------------------------->
                    @foreach($shows->where('show_type','2') as $show)
                    <div class="row">
