...
<div class="wpcf7" id="wpcf7-f156-p143-o1 formwrap">
    <form action='/admin/articleedit/{{$article->id}}' method="post" class="wpcf7-form" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <p>
           <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="heading" value="{{$article->heading}}" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Heading" required>
          </span>

        <h4 style="text-align: left; color: black"><b>Content:</b> </h4>
            <span class="wpcf7-form-control-wrap Message">
            <textarea class="ckeditor" name="content" cols="10" rows="10" aria-invalid="false" placeholder="Content" required>{{$article->content}}</textarea>
          </span>
          <br><br><br>
        <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="writer" value="{{$article->writer}}" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Writer" required>
          </span>


        <span>
                <h4 style="text-align: left; color: black">Select Cover Image*</h4>
                <input type="file" name="image1"  style="font-size: large; background-color: grey" value="{{$article->image1}}">
                <br>

                <h4 style="text-align: left; color: black">Image 2(Not necessary)</h4>
                <input type="file" name="image2"  style="font-size: large; background-color: grey" value="{{$article->image2}}">
                <br>

                <h4 style="text-align: left; color: black">Image 3(Not necessary)</h4>
                <input type="file" name="image3"  style="font-size: large; background-color: grey" value="{{$article->image3}}">
                <br>
