...
<div class="wpcf7" id="wpcf7-f156-p143-o1 formwrap">
    <form action="/admin/showedit/{{$show->id}}" method="post" class="wpcf7-form" enctype="multipart/form-data">
      @csrf
      @method('PATCH')
        <p>
           <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="heading" value="{{$show->heading}}" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Heading " required>
          </span>
            <span class="wpcf7-form-control-wrap Message">
            <textarea name="description" cols="10" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Description " required>{{$show->description}}</textarea>
          </span>
          <br><br>
            <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="show_type" value="{{$show->show_type}}" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Show ID" required>
          </span>
        <h4 style="text-align: left; color: black">Show IDs:-
          <ul>
            <li>BMG S1 -> 1</li><li>Big Debate -> 2</li></ul></h4>
        <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="link" value="{{$show->link}}" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Video's youtube ID " required>
          </span>

            <span>
                <h4 style="text-align: left; color: black">Select Thumbnail</h4>
                <input type="file" name="thumbnail"  style="font-size: large; background-color: grey">
        </span>
            <br><br><br><br>
