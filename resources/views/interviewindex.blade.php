...
<body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/portfolio/04.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span>Interviews</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Interviews</h1>
          </div>
        </div>
      </div>
    </div>
    					...
    					<div class="col-md-12">
			              ...
			              <div class="author mb-4 d-flex align-items-center">
			            		<div class="ml-3 info">
			            			...
			            			<h3><a>{{$interview->reporters}}</a>, <span>{{$interview->created_at->format('F j, Y')}}</span></h3>
			            		</div>
			            	</div>
			              <div class="meta-wrap d-md-flex align-items-center">
			              	<div class="half">
				              	<p><a href="/interview/{{$interview->id}}" class="btn btn-primary p-3 px-xl-4 py-xl-3">Continue Reading</a></p>
                        @auth<p><a href="/admin/interviewedit/{{$interview->id}}" class="btn btn-primary p-3 px-xl-4 py-xl-3">Edit</a></p>@endauth
                        @auth<p><a href="/admin/interviewdelete/{{$interview->id}}" class="btn btn-primary p-3 px-xl-4 py-xl-3">Delete</a></p>@endauth
