     ...
     <div class="navbar-header">
         ...
         <div class="collapse navbar-collapse" id="mynavbar" >
                    <ul class="nav navbar-nav navbar-right">
                         <li><a href="/">Home</a></li>
                        <li class="active"><a href="active" class="page-scroll"> About us </a></li>
                         <li><a href="#"id="events"class="events"> Events </a></li>
                        <li><a href="#"id="shows"class="shows"> Shows </a> </li>
                        <li><a href="#"id="articles"class="articles"> Article </a></li> 
                        <li><a href="#interview" class="page-scroll"> Interviews </a></li>
                        <li><a href="/gallery" id="galley" class="gallery"> Gallery </a></li>
