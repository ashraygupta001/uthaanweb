...
<div class="wpcf7" id="wpcf7-f156-p143-o1 formwrap">
    <form action='/admin/interview' method="post" class="wpcf7-form" enctype="multipart/form-data">
        @csrf
        <p>
        ...
        <h4 style="text-align: left; color: black"><b>Content:</b> </h4>
          ...
          <br><br><br>
        <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="reporter" value="" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Reporter" required>
          </span>

           <span class="wpcf7-form-control-wrap Name">
             <input type="text" name="photographer" value="" size="40" class="nameinput wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Photographer" required>
          </span>
